...
Want to see the limitation first-hand? Try the [Perceptron demo]({{% relref "Chapter 6/perceptron/perceptron.en.md" %}}) and attempt to train a single-layer perceptron on XOR—watch how it inevitably fails.