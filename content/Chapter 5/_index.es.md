...
- **[K-Means y Clustering]({{% relref "Chapter 5/bibliography/bibliography-kmeans-clustering.es.md" %}})**: Recursos y referencias verificadas sobre algoritmos de clustering, aprendizaje no supervisado y el método del codo.