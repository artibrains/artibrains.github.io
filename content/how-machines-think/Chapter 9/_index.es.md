...
1. **[IA en Medicina]({{% relref "how-machines-think/Chapter 9/medicine/medicine.es.md" %}})**: Categorías autorizadas/listadas por FDA + productos reales (p. ej., cribado autónomo, triaje por imagen) y las restricciones de seguridad.
2. **[AlphaFold y estructura de proteínas]({{% relref "how-machines-think/Chapter 9/alphafold/alphafold.es.md" %}})**: Un caso raro de “infraestructura científica”: salto en CASP14 → AlphaFold DB a escala masiva.
3. **[IA en Educación]({{% relref "how-machines-think/Chapter 9/education/education.es.md" %}})**: Tutores y práctica en producción (Khanmigo, Duolingo Max) donde corrección y pedagogía deben estar en el diseño.
4. **[IA en Matemáticas]({{% relref "how-machines-think/Chapter 9/mathematics/mathematics.es.md" %}})**: AlphaGeometry y el patrón que escala confianza: **generador + verificador**.
5. **[IA en Ingeniería de Software]({{% relref "how-machines-think/Chapter 9/software-engineering/software-engineering.es.md" %}})**: Copilotos en IDE y mejoras algorítmicas (AlphaDev) que funcionan porque software tiene verificadores (tests, compilación, revisión).
...
- **[Implementación de IA y Ética]({{% relref "how-machines-think/Chapter 9/bibliography/bibliography-ai-implementation.es.md" %}})**: Recursos sobre despliegue de IA en atención médica, marcos éticos y estudios de casos del mundo real.
