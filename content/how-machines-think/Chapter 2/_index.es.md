...
- **[2.1 Ajustar un Modelo de Regresión Lineal]({{% relref "/how-machines-think/Chapter 2/linear-regression/linear_regresion_game.es.md" %}})**  
   Ajusta manualmente pendiente e intercepto y compara predicciones vs. datos.

- **[2.2 Visualizar el Descenso del Gradiente]({{% relref "/how-machines-think/Chapter 2/metodo-descenso-gradiente/Metodo-del-descenco-del-gradiente.es.md" %}})**  
   Visualiza cómo las actualizaciones iterativas mueven los parámetros hacia menor error.

- **[2.5 Comparar Funciones de Coste]({{% relref "how-machines-think/Chapter 2/error-comparison/error_comparation.es.md" %}})**  
