...
medical_scenario="An engineer needs to tune multiple parameters of a model (or system) to minimize an error measure. They must find a good combination efficiently, without manually testing thousands of possibilities."
medical_highlight="Gradient descent is a general-purpose way to automatically tune parameters by repeatedly moving in the direction that reduces the error fastest, instead of relying on manual trial-and-error."
