...
- **[Álgebra de métricas de evaluación]({{% relref "Chapter 4/math/evaluation-metrics.es.md" %}})**: Derivaciones formales de la matriz de confusión, las variantes de precisión/recall y la AUC multiclase que respaldan los tableros del capítulo.
- **[Fundamentos de Naive Bayes]({{% relref "Chapter 4/math/naive-bayes.es.md" %}})**: De la regla de Bayes al suavizado y la interpretabilidad que sostienen la confianza de Alma en el modelo probabilístico.