...
3.  **[Visualizarás el Descenso del Gradiente]({{% relref "/Chapter 2/metodo-descenso-gradiente/Metodo-del-descenco-del-gradiente.es.md" %}})**: Entenderás la intuición detrás del algoritmo que el equipo utilizó para entrenar su modelo de forma automática, encontrando los parámetros óptimos para minimizar el error.
